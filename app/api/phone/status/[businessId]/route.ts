...
//     // CHANGED: Check if phone endpoints exist for this business
//     const { data: phoneEndpoints, error } = await supabase
...
//     if (error || !phoneEndpoints) {
//       // No active phone number yet
...
//     return NextResponse.json({
//       status: "active",
//       phoneNumber: phoneEndpoints.phone_number,
