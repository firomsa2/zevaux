...
export default function TeamMembersForm() {
  ...
  async function handleAddMember() {
    if (!newMember.name || !newMember.email) {
      notify.form.validationError("Name and email are required");
      return;
    }
    ...
    try {
      ...
      notify.crud.createSuccess("Team member");
    } catch (err: any) {
  ...
  async function handleUpdateMember(member: TeamMember) {
    ...
    try {
      ...
      notify.crud.updateSuccess("Team member");
    } catch (err: any) {
  ...
  async function handleDeleteMember(memberId: string) {
    ...
    try {
      ...
      notify.crud.deleteSuccess("Team member");
    } catch (err: any) {
                ...
                <div className="flex gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      notify.clipboard.copied("Invitation link");
                    }}
                  >
                    Copy
                  </Button>
