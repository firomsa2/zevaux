...
import { OnboardingGuide } from "@/components/onboarding/onboarding-guide";
import { PostOnboardingCelebration } from "@/components/onboarding/post-onboarding-celebration";
import { UsageMeterWidget } from "@/components/dashboard/usage-meter-widget";
...
export function DashboardContent({
  ...
  return (
    <main className="flex-1 px-4 py-6 space-y-6">
      ...
      {/* Upgrade Nudge Banner - Show based on usage percentage */}
      {isSetupComplete && plan && (
        <UpgradeNudgeBanner 
          minutesUsed={minutesUsed}
          minutesLimit={plan.minutes_limit || 200}
          usagePercentage={(minutesUsed / (plan.minutes_limit || 200)) * 100}
          plan={plan}
        />
      )}

      {/* Usage Meter Widget - Show when setup is complete */}
      {isSetupComplete && (
        <UsageMeterWidget 
          plan={plan}
          minutesUsed={minutesUsed}
