...
//   const benefits = [
//     "Answers every call instantly — 24/7/365 so your business is always available",
//     "Books appointments directly into your calendar with no manual work",
//     "Natural, professional voice that feels human — no robotic prompts",
//     "Seamlessly works with your existing phone number — easy setup, no disruptions",
//   ];
...
//       <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-14 pt-12 md:pt-10 pb-16 md:pb-32">
//         <div className="grid gap-12 lg:gap-16 lg:grid-cols-[1.2fr_0.8fr] items-center relative">
...
//               <h1 className="text-2xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl leading-[1.1]">
//                 <span className="">Never Miss Another Business Call </span>
//                 <span className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[var(--neon-cyan)] via-white to-[var(--neon-violet)] animate-gradient-x pb-2">
//                 Capture Every Opportunity
//                 </span>
//               </h1>
//               <p className="text-xl text-white/70 max-w-screen-lg leading-relaxed">
//                 Zevaux is your AI-powered voice receptionist that answers every call naturally, qualifies
//                 leads instantly, and books appointments on your behalf — sounding just like a real
...
//                   </div>
//                   <span className="text-md font-light">{benefit}</span>
//                 </li>
//               ))}
//             </ul>
        ...
        <div className="grid gap-12 lg:gap-16 lg:grid-cols-[1.2fr_0.8fr] items-center relative">
          ...
          <div className="space-y-8 relative z-10">
            ...
            <div className="space-y-4 animate-fade-in-up">
              <h1 className="text-2xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl leading-[1.1]">
                <span className="inline-block bg-clip-text text-transparent bg-gradient-to-r from-[var(--neon-cyan)] via-white to-[var(--neon-violet)] animate-gradient-x pb-2">
                Never Miss Another Business Call—Ever
                </span>
              </h1>
              <p className="text-xl text-white/70 max-w-screen-lg leading-relaxed">
                Zevaux answers every call, sounds human, qualifies leads, and books appointments automatically—24/7.
              </p>
            </div>
            ...
            <div className="space-y-3 pt-4">
              <p className="text-sm text-white/60 font-medium">
                Trusted by 2,000+ businesses • 4.9★ rating • Setup in under 5 minutes
              </p>
          ...
          {/* Right Column - 3-Column Flow Visualization */}
          <div className="relative animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            {/* Connection Arrows between columns */}
            <div className="absolute top-1/2 w-full flex justify-between px-4 pointer-events-none -translate-y-1/2 z-5">
              <div className="flex-1 flex justify-center">
                <div className="text-[var(--neon-cyan)] opacity-40">
            ...
            <div className="grid grid-cols-3 gap-4 lg:gap-6">
              {/* Column 1: Incoming Call */}
              <div className="relative group animate-fade-in" style={{ animationDelay: "0.3s" }}>
                <div className="absolute inset-0 bg-gradient-to-br from-[var(--neon-cyan)]/20 to-transparent rounded-2xl blur-xl group-hover:blur-2xl transition-all" />
                <div className="relative bg-[var(--rich-surface)]/40 backdrop-blur-xl border border-[var(--neon-cyan)]/20 rounded-2xl p-6 h-80">
                  <div className="flex flex-col items-center justify-center h-full space-y-6">
                    <div className="relative">
                      <div className="absolute inset-0 bg-[var(--neon-cyan)] rounded-full blur-lg opacity-30 animate-pulse" />
                      <div className="relative h-20 w-20 rounded-full border-2 border-[var(--neon-cyan)]/30 bg-[var(--neon-cyan)]/5 flex items-center justify-center">
                        <Phone className="h-10 w-10 text-[var(--neon-cyan)]" />
                      </div>
                    </div>
                    <div className="text-center">
                      <h4 className="text-sm font-bold text-white mb-2">Incoming Call</h4>
                      <p className="text-xs text-[var(--neon-cyan)] font-mono">+1 (555) 123-4567</p>
                    </div>
                    <div className="pt-4 text-center">
                      <span className="inline-block px-3 py-1 bg-[var(--neon-cyan)]/10 border border-[var(--neon-cyan)]/20 rounded-full text-xs text-[var(--neon-cyan)] font-medium">
                        24/7 Answered
                      </span>
                    </div>
                  </div>
              ...
              <div className="relative group animate-fade-in" style={{ animationDelay: "0.4s" }}>
                <div className="absolute inset-0 bg-gradient-to-br from-[var(--neon-violet)]/20 to-transparent rounded-2xl blur-xl group-hover:blur-2xl transition-all" />
                <div className="relative bg-[var(--rich-surface)]/40 backdrop-blur-xl border border-[var(--neon-violet)]/20 rounded-2xl p-6 h-80 flex flex-col">
                  <div className="flex items-center gap-2 mb-4 pb-4 border-b border-white/5">
                    <div className="w-2 h-2 rounded-full bg-[var(--neon-violet)] animate-pulse" />
                    <span className="text-xs text-white/60 font-medium">Live Transcript</span>
                  </div>
                  <div className="flex-1 flex flex-col justify-center space-y-4">
                    <div className="bg-white/5 border border-white/5 rounded-lg p-3 text-left">
                      <p className="text-[11px] text-white/70 leading-relaxed">
                        <span className="text-[var(--neon-rose)] font-bold block mb-1">Caller:</span>
                        "I need to book a consultation"
                      </p>
                    </div>
                    <div className="bg-[var(--neon-violet)]/10 border border-[var(--neon-violet)]/20 rounded-lg p-3 text-left">
                      <p className="text-[11px] text-white/80 leading-relaxed">
                        <span className="text-[var(--neon-cyan)] font-bold block mb-1">AI Agent:</span>
                        "Perfect! Thursday at 2 PM?"
                      </p>
                    </div>
                  </div>
                  <div className="mt-auto pt-4 border-t border-white/5">
                    <span className="inline-block px-3 py-1 bg-[var(--neon-violet)]/10 border border-[var(--neon-violet)]/20 rounded-full text-xs text-[var(--neon-violet)] font-medium">
                      Sounds Human
                    </span>
                  </div>
                </div>
              ...
              {/* Column 3: Calendar Booking */}
              <div className="relative group animate-fade-in" style={{ animationDelay: "0.5s" }}>
                <div className="absolute inset-0 bg-gradient-to-br from-[var(--neon-rose)]/20 to-transparent rounded-2xl blur-xl group-hover:blur-2xl transition-all" />
                <div className="relative bg-[var(--rich-surface)]/40 backdrop-blur-xl border border-[var(--neon-rose)]/20 rounded-2xl p-6 h-80 flex flex-col">
                  <div className="flex items-center gap-2 mb-4 pb-4 border-b border-white/5">
                    <Calendar className="h-4 w-4 text-[var(--neon-rose)]" />
                    <span className="text-xs text-white/60 font-medium">Appointment Booked</span>
                  </div>
                  <div className="flex-1 flex flex-col justify-center space-y-4">
                    <div className="bg-white/5 border border-[var(--neon-rose)]/20 rounded-lg p-4">
                      <p className="text-xs text-white/60 mb-2">Thursday, March 20</p>
                      <p className="text-sm font-bold text-white mb-3">2:00 PM</p>
                      <p className="text-xs text-white/70 leading-relaxed">
                        Consultation with prospect
                      </p>
                    </div>
                    <div className="text-center text-xs text-[var(--neon-cyan)]">
            ...
            {/* Micro-badge */}
            <div className="absolute top-0 right-0 inline-flex items-center gap-3 px-3 py-1.5 bg-[var(--rich-surface)]/60 backdrop-blur-md border border-white/10 rounded-full text-xs text-white/70 font-medium">
