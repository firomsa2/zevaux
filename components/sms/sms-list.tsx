...
//     // Manual SMS can be edited in draft status
//     // Hybrid SMS can be edited when pending approval
//     return (
...
//     // Can delete drafts, pending, and failed messages
//     return ["draft", "pending", "failed"].includes(sms.status);
//   };

//   const canApprove = (sms: SMS) => {
//     // Can only approve pending messages in hybrid mode
//     return sms.mode === "hybrid" && sms.status === "pending";
//   };

//   const canSend = (sms: SMS) => {
//     // Manual SMS can be sent from draft
//     // Hybrid SMS can be sent after approval
//     // Fully AI SMS are auto-sent, so no send button
//     return (
//       (sms.mode === "manual" && sms.status === "draft") ||
...
//     // Can retry failed messages in any mode
